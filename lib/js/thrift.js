...
Thrift.TStringTransport = function(recv_buf) {
    this.send_buf = '';
...
Thrift.TNativeJSONProtocol = function(transport) {
    this.transport = transport;
    this.reset();
};

Thrift.TNativeJSONProtocol.Type = {};
Thrift.TNativeJSONProtocol.Type[Thrift.Type.BOOL] = 'tf';
Thrift.TNativeJSONProtocol.Type[Thrift.Type.BYTE] = 'i8';
Thrift.TNativeJSONProtocol.Type[Thrift.Type.I16] = 'i16';
Thrift.TNativeJSONProtocol.Type[Thrift.Type.I32] = 'i32';
Thrift.TNativeJSONProtocol.Type[Thrift.Type.I64] = 'i64';
Thrift.TNativeJSONProtocol.Type[Thrift.Type.DOUBLE] = 'dbl';
Thrift.TNativeJSONProtocol.Type[Thrift.Type.STRUCT] = 'rec';
Thrift.TNativeJSONProtocol.Type[Thrift.Type.STRING] = 'str';
Thrift.TNativeJSONProtocol.Type[Thrift.Type.MAP] = 'map';
Thrift.TNativeJSONProtocol.Type[Thrift.Type.LIST] = 'lst';
Thrift.TNativeJSONProtocol.Type[Thrift.Type.SET] = 'set';

Thrift.TNativeJSONProtocol.getValueFromScope = function(scope) {
  var listvalue = scope.listvalue;
  return listvalue ? listvalue.shift() : scope.value;
};

Thrift.TNativeJSONProtocol.getScopeFromScope = function(scope) {
  var listvalue = scope.listvalue;
  if(listvalue)
...
Thrift.TNativeJSONProtocol.prototype = {
    ...
    //Write functions
    writeMessageBegin: function(name, messageType, seqid) {
      throw new Error("TNativeJSONProtocol: Message not supported");
    },
    ...
    writeFieldBegin: function(name, fieldType, fieldId) {
      var field = {name:name, fieldType:Thrift.TNativeJSONProtocol.Type[fieldType], fieldId:fieldId, value:[]};
    ...
    writeMapBegin: function(keyType, valType, size) {
      var map = {value:[
        Thrift.TNativeJSONProtocol.Type[keyType],
        Thrift.TNativeJSONProtocol.Type[valType],
        size
      ]};
    ...
    writeListBegin: function(elemType, size) {
      var list = {name:name, value:[
        Thrift.TNativeJSONProtocol.Type[elemType],
        size
      ]};
    ...
    readStructBegin: function(name) {
      ...
      if(this.elementStack.length == 0)
        ...
        value = Thrift.TNativeJSONProtocol.getValueFromScope(this.elementStack[0]);
    ...
    readFieldBegin: function() {
      ...
      var scopeValue = Thrift.TNativeJSONProtocol.getValueFromScope(scope);
    ...
    readMapBegin: function(keyType, valType, size) {
      var scope = this.elementStack[0];
      var value = Thrift.TNativeJSONProtocol.getValueFromScope(scope);
      var result = {
    ...
    readBool: function() {
      return {
        value:(Thrift.TNativeJSONProtocol.getValueFromScope(this.elementStack[0]) != 0)
      };
    },

    readByte: function() {
      return Thrift.TNativeJSONProtocol.getScopeFromScope(this.elementStack[0]);
    },
