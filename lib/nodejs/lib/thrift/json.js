...
var TStringTransport = exports.TStringTransport = function(recv_buf) {
    this.send_buf = '';
...
var TNativeJSONProtocol = exports.TNativeJSONProtocol = function(transport) {
...
TNativeJSONProtocol.prototype = {
    ...
    readByte: function() {
      return getScopeFromScope(this.elementStack[0]);
    },
