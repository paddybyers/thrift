  ...
  encode: function(string, view, off) {
    ...
    for(var n = 0; n < string.length; n++) {
      ...
      if (c < 128) {
        ...
        view.setInt8((c >> 6) | 192, pos++);
        view.setInt8((c & 63) | 128, pos++);
      } else {
        view.setInt8((c >> 12) | 224, pos++);
        view.setInt8(((c >> 6) & 63) | 128, pos++);
        view.setInt8((c & 63) | 128, pos++);
      }
    }
    return (pos - off);
...
Buffer.prototype = {
  ...
  slice: function(start, end) {
    ...
    result.view = new DataView(this.buf, result.offset);
  },
...
var CheckedBuffer = function(length) {
